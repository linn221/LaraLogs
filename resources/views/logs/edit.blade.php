    ...
    <div class=" container-sm">
        <div class="row">
            ...
            <div class="mb-3">
                ...
                <textarea form="createLogForm" name="content" class=" form-control " rows="10">{{ old('content', $log->content) }}</textarea>
            </div>
            <div class="mb-3">
                ...
                @foreach (App\Models\Category::all() as $category)
                    <option value="{{ $category->id }}" {{ old('category', $log->category_id) == $category->id ? 'selected' : '' }}>
                        {{ $category->name }}
                    </option>
                @endforeach
